---
title: "16. Figure C.5 Calculations"
---
...
# Find ids high mobile phone consumers
ids = c(
  trimws(subset(foreign::read.spss(paste0(datadir, "s1_survey_raw.sav"), 
                                   to.data.frame = T), 
                q2.3__net_devices_x1 > 50)$w1id, "right"),
  subset(read.csv(paste0(datadir, "s2_survey_raw.csv")), 
           percent_phone_w1 > 50)$person_id)
...
# subset mobile users 
visits_s1 = visits_s1[visits_s1$person_id %in% ids,]
visits_s2 = visits_s2[visits_s2$person_id %in% ids,] 

totals_s1 = totals_s1[totals_s1$person_id %in% ids,]
totals_s2 = totals_s2[totals_s2$person_id %in% ids,]
```
...
write_xlsx(summstats, paste0(tabdir, "Figure C.5 - Data.xlsx"))
```
